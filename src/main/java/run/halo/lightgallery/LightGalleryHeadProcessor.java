        ...
        return reactiveSettingFetcher.fetch("basic", BasicConfig.class)
                .doOnNext(basicConfig -> {
                    ...
                    if (StringUtils.isNotBlank(domSelector) && isContentTemplate(context)) {
                        model.add(modelFactory.createText(lightGalleryScript(Set.of(domSelector)) + backdropStyle(basicConfig.getBackdropColor())));
                    }
                    ...
                    model.add(modelFactory.createText(lightGalleryScript(matchResult.domSelectors()) + backdropStyle(basicConfig.getBackdropColor())));
                })
                .onErrorResume(e -> {
